...
const (
	...
	AlbumDetailServiceName = "album_detail_service.v1.AlbumDetailService"
)
...
const (
	...
	// GetAlbumDetail RPC.
	AlbumDetailServiceGetAlbumDetailProcedure = "/album_detail_service.v1.AlbumDetailService/GetAlbumDetail"
)
...
// AlbumDetailServiceClient is a client for the album_detail_service.v1.AlbumDetailService service.
...
// album_detail_service.v1.AlbumDetailService service. By default, it uses the Connect protocol with
...
// GetAlbumDetail calls album_detail_service.v1.AlbumDetailService.GetAlbumDetail.
...
// AlbumDetailServiceHandler is an implementation of the album_detail_service.v1.AlbumDetailService
// service.
...
func NewAlbumDetailServiceHandler(svc AlbumDetailServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/album_detail_service.v1.AlbumDetailService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAlbumDetailServiceHandler) GetAlbumDetail(context.Context, *connect.Request[v1.GetAlbumDetailRequest]) (*connect.Response[v1.GetAlbumDetailResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("album_detail_service.v1.AlbumDetailService.GetAlbumDetail is not implemented"))
}
