...
const (
	...
	AlbumListServiceName = "proto.album_list_service.v1.AlbumListService"
)
...
const (
	...
	// GetAlbumList RPC.
	AlbumListServiceGetAlbumListProcedure = "/proto.album_list_service.v1.AlbumListService/GetAlbumList"
)
...
// AlbumListServiceClient is a client for the proto.album_list_service.v1.AlbumListService service.
...
// NewAlbumListServiceClient constructs a client for the
// proto.album_list_service.v1.AlbumListService service. By default, it uses the Connect protocol
...
// GetAlbumList calls proto.album_list_service.v1.AlbumListService.GetAlbumList.
...
// AlbumListServiceHandler is an implementation of the proto.album_list_service.v1.AlbumListService
// service.
...
func NewAlbumListServiceHandler(svc AlbumListServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/proto.album_list_service.v1.AlbumListService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAlbumListServiceHandler) GetAlbumList(context.Context, *connect.Request[v1.GetAlbumListRequest]) (*connect.Response[v1.GetAlbumListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.album_list_service.v1.AlbumListService.GetAlbumList is not implemented"))
}
